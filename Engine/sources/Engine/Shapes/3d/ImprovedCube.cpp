...
#include "ImprovedCube.hpp"

namespace engine::shape3d {

ImprovedCube::ImprovedCube(engine::Shader &shaderProgram)
...
ImprovedCube::~ImprovedCube()
{}

void ImprovedCube::addPosition(float x /* = 0 */, float y /* = 0 */, float z /* = 0 */)
{
    this->m_Positions.push_back(glm::vec3(x, y, z));
}
void ImprovedCube::addPosition(glm::vec3& vec)
{
    this->m_Positions.push_back(vec);
}

void ImprovedCube::draw(const engine::Camera& camera)
{
