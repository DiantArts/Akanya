...
Example::Example()
{
    ...
    lightSource.instances.move(-0.0F, 2.0F, 0.0F);
    ...
    cube.instances.move(0.0F, 0.0F, 0.0F);
    ...
    backpack.instances.move(-5.0F, 2.0F, 0.0F);
    backpack.instances.add(5.0F, 2.0F, 0.0F);
}
